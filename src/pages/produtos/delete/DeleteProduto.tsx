...
import { Warning, Trash, X, FirstAidKit } from "phosphor-react";
      ...
      <div className="bg-white rounded-[2rem] border border-slate-100 shadow-xl w-full max-w-lg overflow-hidden animate-fade-in-up">
        ...
        <div className="p-10 flex flex-col items-center text-center">
          ...
          <p className="text-slate-500">
            Você tem certeza que deseja excluir este produto? <br /> Esta ação é irreversível.
          </p>
          ...
          <div className="w-full mt-8 bg-slate-50 border border-slate-100 rounded-2xl p-6 text-left relative overflow-hidden group">
            ...
            <div className="flex items-center gap-2 mb-2">
              <FirstAidKit size={16} className="text-cyan-600" weight="fill" />
              <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Produto Selecionado</span>
            </div>
